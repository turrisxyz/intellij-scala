...
object ScalaFeatures {
  ...
  private val minorVersion7  = Version("7")
  private val minorVersion9  = Version("9")
  private val minorVersion14 = Version("14")
  private val minorVersion15 = Version("15")
  ...
  def apply(version: ScalaVersion,
    ...
    val `in >= 2.12.15 or 2.13.7 with -XSource:3 or 3`: Boolean =
      forMinorVersion(version, isScala3, _ > minorVersion15 && hasSource3Flag, _ > minorVersion7 && hasSource3Flag)
    val `in >= 2.12.15 or 2.13.7 or 3`: Boolean =
      forMinorVersion(version, isScala3, _ > minorVersion15, _ > minorVersion7)
